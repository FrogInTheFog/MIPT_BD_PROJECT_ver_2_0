...
class StreamsWindow(QMainWindow):
    ...
    def print_table(self, table):
        count_str = self.loginDatabase.count_strings() + StreamsWindow.additional_strings_count
        ...
        for counter, value in enumerate(select_result):
            ...
            for j in range(len(value) + StreamsWindow.additional_strings_count):
                # print("j = " + str(j))
                if j >= len(value):
                    data = ""
                else:
    ...
    def add_string(self):
        new_count = StreamsWindow.additional_strings_count + 1
        StreamsWindow.additional_strings_count = new_count
    ...
    def delete_empty(self):
        ...
        new_count = StreamsWindow.additional_strings_count - empty_count
        StreamsWindow.additional_strings_count = new_count
