...
class DepartmentsWindow(QMainWindow):
    ...
    def print_table(self, table):
        count_str = self.loginDatabase.count_strings() + DepartmentsWindow.additional_strings_count
    ...
    def add_string(self):
        new_count = DepartmentsWindow.additional_strings_count + 1
        DepartmentsWindow.additional_strings_count = new_count
    ...
    def delete_empty(self):
        ...
        new_count = DepartmentsWindow.additional_strings_count - empty_count
        DepartmentsWindow.additional_strings_count = new_count
